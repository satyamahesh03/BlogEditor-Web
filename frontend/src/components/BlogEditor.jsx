...
const BlogEditor = ({ blogId }) => {
  ...
  useEffect(() => {
    ...
    const fetchBlog = async () => {
      try {
        ...
        const res = await axios.get(`${import.meta.env.VITE_API_URL}/blogs/${currentBlogId}`, {
          headers: {
  ...
  const handleSaveDraft = async (auto = false) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/blogs/save-draft`, {
        id: currentBlogId,
        title,
        content,
  ...
  const handlePublish = async () => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/blogs/publish`, {
        id: currentBlogId,
        title,
        content,
  ...
  return (
    <div className={styles.editorContainer}>
      ...
      <input
        type="text"
        placeholder="Tags :-   'eg: machineLearning, futurOfAI, AItools'"
        value={tags}
        onChange={(e) => {
